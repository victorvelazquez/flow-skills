...
export function validateSnapshot(value) {
  ...
  exact(value.base, ["oid", "ref", "repository"], "snapshot.base"); validateRepo(value.base.repository, "snapshot.base.repository"); validateRef(value.base.ref, "snapshot.base.ref"); validateOid(value.base.oid, "snapshot.base.oid");
